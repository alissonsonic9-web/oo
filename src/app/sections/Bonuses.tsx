        ...
        <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pt-8">
              {bonuses.map((bonus, index) => {
                ...
                return (
                    <div key={index} className="group relative flex flex-col items-center text-center bg-card border border-border/20 rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:border-accent hover:shadow-accent/20 min-h-[360px]">
